...
> Website traffic made up of visitors who are likely to become customers

> **Conversion Rate (CR)** <br/>
> The percentage of users who _complete a desired action_ to the success of the business

> **Cart Abandonment Rate (CAR)** <br/>
> The percentage of customers who add a product to their shopping 
> cart and leave the store without completing their purchase

> **Average Order Value (AOV)** <br/>
> Tracks the average amount of money a customer spends each time they complete an order
> _The company can increase its incomes_
...
> **Customer Lifetime Value (CLV)** <br/>
> Average revenue generated by customers over a certain period of time

> **Customer Retention Rate (CRR)** <br/>
> Percentage of customers that a company retains over a certain period of time

- [x] Conversion rate optimization 
> Process of increasing the percentage of website visitors who complete a desired action

> **Cross-selling** <br/>
> Sales technique used to encourage customers to spend more by 
> purchasing a product that's _related_ to what they're already buying

> **Upselling** <br/>
> Sales technique used to encourage customers to spend more by upgrading to a _more expensive_ product

_bundle deals_ <br/>
_minimum for free shipping_ <br/>
_rewards program_ <br/>

- [x] __BENEFITS OF PRODUCT ANALYTICS__

* Evaluate wheter a product is successful
* Figure out why a product is underperforming
* Identify opportunities for improvement
* Avoid selling products that don't benefit the business or could harm their brand's reputation
